...
![支行列表页面](image/branches-index.png)

#### 支行详细信息页面

![支行详细信息页面](image/branches-show.png)

#### 账户编辑页面

![账户编辑页面](image/accounts-edit.png)

#### 支行的关联账户页面

![支行的关联账户页面](image/branches-accounts.png)

#### 账户的关联客户页面

![账户的关联客户页面](image/accounts-owners.png)

#### 贷款的支付页面

![贷款的支付页面](image/loans-issues.png)

#### 「业务统计」页面

![业务统计页面](image/stats.png)

#### 业务统计的搜索页面

![业务统计的搜索页面](image/stats-search.png)

![业务统计的搜索结果页面](image/stats-search-results.png)
...
![创建支行](image/branches-create.png)

##### 更新支行

![更新支行](image/branches-update.png)

##### 删除支行

![删除支行](image/branches-destroy.png)

##### 账户新增关联客户

![账户新增关联客户](image/ownerships-create.png)

##### 贷款新增支付

![贷款新增支付](image/issues-create.png)

#### 4.2.2 操作失败结果

##### 创建支行

![创建支行](image/branches-create-fail.png)

##### 删除支行

![删除支行](image/branches-destroy-fail.png)

##### 更新账户

修改开户支行

![更新账户](image/accounts-edit-fail.png)

错误的账户余额

![更新账户](image/accounts-edit-fail-2.png)

##### 贷款支付

![贷款支付](image/issues-create-fail.png)

若修改前端强行提交不正确的数值

![贷款支付](image/issues-create-fail-2.png)
...
![Browser History](image/browser-history.png)
...
![Word Count on Controllers](image/wc-controllers.png)
...
![Stack Overflow Tags](image/so-tags.png)
